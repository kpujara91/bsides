...
export const HomeContent = {
    ...
    SpeakersAttending:{
        ...
        CxoSpeakerList:[
            ...
            },
            {
                ...
                speakerDesignation: `Chief Information Officer @ Adani Green Energy Ltd. & Adani Solar`,
                speakerSocialMediaList:[
                    {
                        title:'Linkedin',
                        icon: IconLinkedin,
    ...
    SpeakersBio:{
        ...
        SpeakersBioList: [
            {
                title: "KEYNOTE 1",
                description: "Guy Hawkins",
                src: KeynoteImage1,
                ctaText: "View",
                content: () => {
                    return (
                    <p>
                        {`Shubham Shah is a top cybersecurity expert and entrepreneur, known for co-founding Assetnote - a leading attack surface management platform. He's ranked as the #1 bug bounty hunter in Australia for three consecutive years and #27 in the world on HackerOne.`}
                    </p>
                    );
                },
            },
