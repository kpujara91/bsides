...
//                                                                     </Link>
//                                                                     <span>{items?.extraTitle &&  items?.extraTitle}</span>
//                                                                 </div>
//                                                             </React.Fragment>
//                                                         )
//                                                     })
...
//                                                                         <Image src={items?.ImagePath} alt='Sponsors Image' width={300} height={100}/>
//                                                                     </Link>
//                                                                     {items?.extraTitle && <span>{items?.extraTitle}</span>}
//                                                                 </div>
//                                                             </React.Fragment>
//                                                         )
//                                                     })
                    ...
                    <div className={`${styles.SponsorsDetailsWrapper}`}>
                        {
                            pathname === "/" ?
                                (
                                    ConferenceContent?.Sponsors?.SponsorsContent?.slice(0, 8).map((lists, i) => {
                                        return (
                                            <React.Fragment key={i}>
                                                <div className={`${styles.sponsorsLists}`}>
                                                    <div className={`title-wrapper ${styles.titleWrapper}`}>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                {items?.extraTitle !==
                                                                                    ...
                                                                                    <>
                                                                                        ...
                                                                                        <span className="text-center py-6 text-white">
                                                                                            {
                                                                                                items?.extraTitle
                                                                                            }
                                                                                        </span>
